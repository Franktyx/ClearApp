...
class myTableViewCell: UITableViewCell {
    ...
    var ticketLabel: UILabel, crossLabel: UILabel
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        ticketLabel = createCueLabel()
        ticketLabel.text = "\u{2713}"
        ...
        //gradient layer in each tableview cell
    ...
    func handlePan(recognizer: UIPanGestureRecognizer){
        if recognizer.state == .Began {
            ...
            ticketLabel.alpha = cueAlpha
            crossLabel.alpha = cueAlpha
            
            ticketLabel.textColor = completeOnDragRelease ? UIColor.greenColor() : UIColor.whiteColor()
    ...
    //ensure vertical pan won't cause cell operation
    ...
    override func layoutSubviews() {
        ...
        ticketLabel.frame = CGRect(x: -kUICuesWidth - kUICuesMargin, y: 0, width: kUICuesWidth, height: bounds.size.height)
